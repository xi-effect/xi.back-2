...
from tests.tutors.factories import (
...
async def test_group_classroom_creation(
    ...
    classroom_id = assert_response(
        tutor_client.post(
            "/api/protected/tutor-service/roles/tutor/group-classrooms/",
            json=input_data,
        ),
...
async def test_classroom_retrieving(
    ...
    assert_response(
        tutor_client.get(
            f"/api/protected/tutor-service/roles/tutor/classrooms/{any_classroom.id}/",
        ),
...
async def test_individual_classroom_updating(
    ...
    assert_response(
        tutor_client.patch(
            f"/api/protected/tutor-service/roles/tutor/individual-classrooms/{individual_classroom.id}/",
            json=patch_data,
        ),
        expected_json={
...
async def test_group_classroom_updating(
    ...
    assert_response(
        tutor_client.patch(
            f"/api/protected/tutor-service/roles/tutor/group-classrooms/{group_classroom.id}/",
            json=patch_data,
        ),
        expected_json={
...
async def test_classroom_status_updating(
    ...
    assert_nodata_response(
        tutor_client.put(
            f"/api/protected/tutor-service/roles/tutor/classrooms/{any_classroom.id}/status/",
...
async def test_classroom_requesting_access_denied(
    ...
    assert_response(
        outsider_client.request(
            method,
            f"/api/protected/tutor-service/roles/tutor/{collection}/{classroom.id}/{path}",
