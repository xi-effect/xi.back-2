...
from app.notifications.schemas.vk import vk_base_sch, vk_updates_sch, vk_users_sch
...
class UserResponseFactory(BaseModelFactory[vk_users_sch.UserResponseSchema]):
    __model__ = vk_users_sch.UserResponseSchema
