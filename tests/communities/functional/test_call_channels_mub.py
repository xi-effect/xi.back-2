...
async def test_call_channel_livekit_token_generating(
    ...
    expected_config_base_url = URL(settings.livekit_demo_base_url)
    ...
    assert_contains(
        ...
        {
            "scheme": expected_config_base_url.scheme,
            "netloc": expected_config_base_url.netloc,
            "path": expected_config_base_url.path,
            "query_params": {
                "token": response_json["token"],
                "liveKitUrl": token_input_data.config.url,
            },
        },
    )
