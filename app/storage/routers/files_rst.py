...
@router.post(  # TODO remove in 41239612
    ...
    summary="Use POST /file-kinds/uncategorized/files/ instead",
    deprecated=True,
)
@router.post(
...
async def upload_uncategorized_file(
    upload: UploadFile, auth_data: AuthorizationData
) -> File:
...
@router.post(  # TODO remove in 41239612
    ...
    summary="Use POST /file-kinds/image/files/ instead",
    deprecated=True,
)
@router.post(
...
async def upload_image_file(upload: UploadFile, auth_data: AuthorizationData) -> File:
