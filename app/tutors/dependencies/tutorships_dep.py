...
MUBTutorshipByIDs = Annotated[Tutorship, Depends(get_mub_tutorship_by_ids)]


@with_responses(TutorshipResponses)
async def get_tutor_tutorship_by_ids(
...
TutorTutorshipByIDs = Annotated[Tutorship, Depends(get_tutor_tutorship_by_ids)]


@with_responses(TutorshipResponses)
async def get_student_tutorship_by_ids(
    auth_data: AuthorizationData,
    tutor_id: Annotated[int, Path()],
) -> Tutorship:
    return await get_tutorship_by_ids(
...
StudentTutorshipByIDs = Annotated[Tutorship, Depends(get_student_tutorship_by_ids)]
